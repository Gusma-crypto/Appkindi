...
<div class="login-box" style="min-width: 35% !important; ">
  ...
  <div class="card">
    <div class="card-body login-card-body" style="border-radius: 10px;">
      ...
      <form action="https://javawebmedia.com/signin/lupa" method="post" accept-charset="utf-8">
      <input type="hidden" name="pengalihan" value="">
        <div class="input-group mb-3">
          <input type="email" class="form-control" name="email" placeholder="Email (username) Anda" required>
          ...
          <div class="form-group">
            <button type="submit" name="submit" class="btn btn-success btn-lg btn-block btn-flat"><i class="fa fa-key"></i> Reset Password Saya</button>
          </div>
          <!-- /.col -->
        </div>
      </form>
      ...
      <p class="mb-1 text-center">
        <a href="<?= base_url('admin/auth') ?>">Login</a> | <a href="<?= base_url() ?>" class="text-center">Home</a>
      </p>
    </div>
    <!-- /.login-card-body -->
  </div>
